...
const sections = [
  ...
  { id: "use", title: "How We Use Your Data", content: "We use data to operate accounts, show listings, process payments, support verification, prevent fraud, improve search quality, send service messages, and comply with legal obligations in Zimbabwe." },
