...
const sections = [
  ...
  { id: "payments-fees", title: "Payments & Fees", content: "Town Ruins may charge platform fees, premium access fees, listing fees, token-based engagement charges, or booking-related fees. Fees shown before purchase are payable under the terms displayed at checkout." },
