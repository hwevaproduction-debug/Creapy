...
const sections = [
  ...
  { id: "non-refundable", title: "Non-Refundable Bookings", content: "Non-refundable purchases, tokens, and promotional fees are not refundable unless required by law or explicitly stated at checkout." },
